...
<style>
    .availability-page { display:grid; gap:20px; }
    .availability-header { display:flex; justify-content:space-between; align-items:flex-start; gap:16px; flex-wrap:wrap; }
    .availability-title { margin:0; font-size:28px; font-weight:800; color:#0f172a; }
    .availability-subtitle { margin:8px 0 0; max-width:760px; color:#64748b; font-size:14px; line-height:1.7; }
    ...
    .availability-left, .availability-right { display:grid; gap:18px; }
    ...
    .availability-panel-body { padding:20px; }
    ...
    .section-title { margin:0; font-size:20px; font-weight:800; color:#0f172a; }
    .section-text { margin:6px 0 0; color:#64748b; font-size:13px; line-height:1.6; }

    .calendar-card-top { padding:20px; border-bottom:1px solid #eef2f7; background:#fff; }
    ...
    .calendar-title { margin:0; font-size:22px; font-weight:800; color:#0f172a; }
    ...
    .selected-date-label { font-size:13px; font-weight:700; color:#64748b; }
    ...
    .calendar-action-buttons { display:flex; gap:10px; flex-wrap:wrap; }
    ...
    .calendar-cell.muted, .calendar-cell.muted:hover { background:#fbfdff; cursor:not-allowed; }
    .calendar-cell.weekly-available { background:#f8fffb; }
    .calendar-cell.weekly-unavailable { background:#fff; }
    .calendar-cell.override-available { background:#ecfdf5; }
    .calendar-cell.override-unavailable { background:#fef2f2; }
    .calendar-cell.blocked { background:#fff7ed; }
    .calendar-cell.selected { box-shadow:inset 0 0 0 2px #0f766e; }

    .calendar-date { font-size:13px; font-weight:800; color:#334155; margin-bottom:8px; }
    .calendar-cell.muted .calendar-date { color:#cbd5e1; }
    ...
    .calendar-mini-tag.available { background:#d1fae5; color:#065f46; }
    .calendar-mini-tag.partial { background:#eff6ff; color:#2563eb; }
    .calendar-mini-tag.off { background:#f1f5f9; color:#64748b; }
    .calendar-mini-tag.blocked { background:#fee2e2; color:#b91c1c; }

    .bulk-actions { display:flex; gap:10px; flex-wrap:wrap; margin-bottom:16px; }

    .bulk-btn, .primary-btn, .danger-soft-btn, .remove-btn {
        border-radius:14px;
        font-weight:800;
        cursor:pointer;
    }
    ...
    .day-card { border:1px solid #e7edf3; border-radius:16px; background:#fff; overflow:hidden; }
    ...
    .accordion-day-header-left { display:grid; gap:6px; }
    .accordion-day-header-right { display:flex; align-items:center; gap:12px; flex-shrink:0; }
    ...
    .accordion-day-card.is-open .accordion-day-arrow { transform:rotate(180deg); }
    .accordion-day-content { border-top:1px solid #eef2f7; background:#fff; }

    .day-name { margin:0; font-size:17px; font-weight:800; color:#0f172a; }
    .day-meta { font-size:13px; color:#64748b; line-height:1.5; }
    ...
    .day-status.available { background:#ecfdf5; color:#047857; }
    .day-status.unavailable { background:#f1f5f9; color:#64748b; }

    .day-main { padding:16px; display:grid; gap:14px; }
    ...
    .mini-select-wrap { min-width:180px; }

    .mini-label, .input-label {
        display:block;
        margin-bottom:8px;
        font-size:12px;
        font-weight:800;
    ...
    .mini-select:focus, .input-field:focus {
        outline:none;
        border-color:#0f766e;
    ...
    .simple-form, .block-list { display:grid; gap:14px; }
    ...
    .block-date { font-size:15px; font-weight:800; color:#0f172a; }
    .block-time { margin-top:6px; font-size:13px; color:#64748b; }
    .block-reason { margin:10px 0 14px; font-size:13px; color:#475569; line-height:1.6; }
    ...
    @media (max-width:767.98px) {
        .day-input-grid, .summary-grid { grid-template-columns:1fr; }
                ...
                <div class="calendar-card-top">
                    <div class="calendar-toolbar">
                        <div class="calendar-toolbar-left">
                            <a href="{{ route('dentist.availability.index', ['month' => now()->format('Y-m')]) }}" class="calendar-btn">Today</a>
                            <a href="{{ route('dentist.availability.index', ['month' => $previousMonth]) }}" class="calendar-btn">←</a>
                            <h3 class="calendar-title">{{ $summary['month'] }}</h3>
                            <a href="{{ route('dentist.availability.index', ['month' => $nextMonth]) }}" class="calendar-btn">→</a>
                        </div>
                    ...
                    <div id="calendarActionBox" class="calendar-action-box">
                        <div class="calendar-action-top">
                            ...
                            <button type="button" id="closeCalendarActionBox" class="calendar-btn">Close</button>
                        </div>

                        <div class="calendar-action-buttons">
    <button type="button" id="actionFullDayAvailable" class="calendar-btn">Available</button>
    <button type="button" id="actionMorningAvailable" class="calendar-btn">Half Day - Morning</button>
    <button type="button" id="actionAfternoonAvailable" class="calendar-btn">Half Day - Afternoon</button>
    <button type="button" id="actionMarkUnavailable" class="calendar-btn">Unavailable</button>
    <button type="button" id="actionSetTimeRange" class="calendar-btn">Custom Time Range</button>
</div>
                    </div>
                ...
                <div class="availability-panel-body">
                    <div class="section-head">
                        <div>
                            ...
                            <p class="section-text">Quick overview of your monthly setup.</p>
                        </div>
                    </div>
                ...
                <div class="availability-panel-body">
                    <div class="section-head">
                        <div>
                            ...
                            <p class="section-text">Use this when you want to block only a specific time range.</p>
                        </div>
                    </div>
                ...
                <div class="availability-panel-body">
                    <div class="section-head">
                        <div>
                            ...
                            <p class="section-text">Remove blocked dates when needed.</p>
                        </div>
                    </div>
