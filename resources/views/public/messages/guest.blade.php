...
<div style="max-width:720px; margin:40px auto; background:#fff; border:1px solid #e2e8f0; border-radius:16px; padding:24px;">
    <h1 style="margin-top:0;">Guest Message</h1>
    <p style="color:#64748b;">
        Request Code: <strong>{{ $appointmentRequest->request_code }}</strong>
    </p>
    ...
    <form method="POST" action="{{ route('messages.guest.send', $appointmentRequest->request_code) }}">
        @csrf
