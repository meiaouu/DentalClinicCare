...
@section('content')
    ...
    <section id="home" style="position: relative; min-height: 100vh; overflow: hidden; color: white; padding: 160px 24px 100px;">
        ...
        <div style="position: absolute; inset: 0; background: linear-gradient(135deg, rgba(15, 23, 42, 0.78) 0%, rgba(15, 23, 42, 0.68) 45%, rgba(30, 41, 59, 0.62) 100%);"></div>

        <div style="max-width: 1100px; margin: 0 auto; position: relative; z-index: 1;">
            <p style="font-size: 22px; margin-bottom: 16px; color: #cbd5e1;">Professional Dental Care</p>

            <h1 style="font-size: clamp(38px, 8vw, 64px); line-height: 1.1; font-weight: 800; margin-bottom: 24px; max-width: 700px; text-shadow: 0 3px 18px rgba(0, 0, 0, 0.35);">
                Healthy Smiles<br>Start Here
            </h1>

            <p style="max-width: 700px; font-size: 18px; line-height: 1.8; color: #e2e8f0; margin-bottom: 32px; text-shadow: 0 2px 12px rgba(0, 0, 0, 0.25);">
            ...
            <div style="display: flex; gap: 16px; flex-wrap: wrap;">
                <a href="{{ route('booking.entry') }}"
                   style="display: inline-block; padding: 14px 24px; background: #2563eb; color: white; border-radius: 999px; font-weight: 600; box-shadow: 0 10px 25px rgba(37, 99, 235, 0.35);">
                    Book Now
                </a>

                <a href="#services"
                   style="display: inline-block; padding: 14px 24px; border: 1px solid rgba(255,255,255,0.85); color: white; border-radius: 999px; font-weight: 600; background: rgba(255,255,255,0.06);">
                    View All Services
                </a>
            </div>
        </div>
